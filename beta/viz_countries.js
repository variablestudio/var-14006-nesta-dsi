var vizCountriesInit = (function() {
  ...
  var euCountries = ['GBR', 'FRA', 'NLD', 'ESP', 'DEU', 'FIN', 'BEL', 'PRT', 'CHE', 'DNK', 'ITA', 'IRL', 'AUT', 'SWE', 'LUX', 'HUN', 'POL', 'ISL', 'ROU', 'SVK', 'NOR'];
  ...
  var buildCharts = function(data) {
    data.forEach(function(data) {
      if (euCountries.indexOf(data.country_code) == -1) {
        return;
      }
      var div = d3.select("#countriesViz")
        .append("div")
